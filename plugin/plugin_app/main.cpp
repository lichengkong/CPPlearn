...
std::unordered_map<std::string, std::shared_ptr<plugin_resolver>> g_plugin_map {
  {"custom_plugin", std::make_unique<plugin_resolver>("/home/ck/workspace/CPPlearn/build/plugin/libcustom.so")},
  {"dummy_plugin", std::make_unique<plugin_resolver>("/home/ck/workspace/CPPlearn/build/plugin/libdummy.so")}
};
