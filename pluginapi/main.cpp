...
int main(int argc, char *argv[])
{
    ...
    boost::dll::fs::path lib_path("/home/zhiyang.li/workspace/boostproj/build");  // argv[1] contains path to directory with our plugin library
    ...
    plugin = dll::import<my_plugin_api>( // type of imported symbol is located between `<` and `>`
        lib_path / "dllsum",             // path to the library and library name
